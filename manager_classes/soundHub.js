/**
 * Central management of all game sounds with mute functionality and localStorage persistence.
 */
export class SoundHub {
    ...
    /**
     * Collects all sound objects from all categories into an array.
     * @returns {HTMLAudioElement[]} Array of all registered sounds.
     */
    static getAllSounds() {
    ...
    /**
     * Toggles the mute state and persists it in localStorage.
    ...
    /**
     * Applies the current mute state and volume to all sounds.
     */
    static applyMute() {
